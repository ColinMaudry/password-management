Avant de rentrer dans le vif du sujet, nous commnecerons par décire la situation dans laquelle se trouvent de nombreuses personnes et pourquoi c'est problématique :
...
- l'inscription à un service, et donc la création d'un nouveau mot de passe, est un casse-tête, ce qui décourage beaucoup de personnes d'utiliser de nouveaux services en ligne
